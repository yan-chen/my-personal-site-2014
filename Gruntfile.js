    ...
    grunt.initConfig({
        ...
        clean: {
            dist: {
                files: [
                    {
                        dot: true,
                        src: ['.tmp', '<%= yeoman.dist %>/*', '!<%= yeoman.dist %>/.git*', /* config info from https://medium.com/console-log-yo/launching-apps-with-yeoman-1d0dfa627305 */ '!<%= yeoman.dist %>/Procfile', '!<%= yeoman.dist %>/package.json', '!<%= yeoman.dist %>/web.js', '!<%= yeoman.dist %>/node_modules']
                    }
                ]
            },
            server: '.tmp'
                ...
                files: [
                    {
                        ...
                        cwd: '<%= yeoman.app %>',
                        dest: '<%= yeoman.dist %>',
                        src: ['*.{ico,png,txt}', '.htaccess', '*.html', 'views/{,*/}*.html', 'images/{,*/}*.{webp}', 'data/*', 'fonts/*', '.tmp/styles/**', '<%= yeoman.app %>/styles/{,}*.css', 'CNAME*']
                    },
                    {
                        expand: true,
                        cwd: '.tmp/images',
                        dest: '<%= yeoman.dist %>/images',
                        src: ['generated/*']
                    } /* this block of code is a solution to the sass issue found on github */ /* http://stackoverflow.com/questions/21932451/assets-missing-in-angular-application-built-using-grunt */
                    /*,
                     {
                     expand: true,
                     flatten: true,
        ...
        karma: {
            unit: {
                ...
                singleRun: true
                //                autoWatch: true // or background: true
                //                options:{
                //                    files:['test/**/*.js']
                //                }
            }
        ...
        buildcontrol: {
            ...
            pages: {
                options: {
                    remote: 'git@github.com:ychen18/ychen18.github.io.git',
                    branch: 'master'
                }
            },
            /*
